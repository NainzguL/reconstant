...
class COutputer (Outputer):
    ...
    def output_constant(self, constant: Constant):
        constantType = 'char*' if constant.constantType == str else constant.constantType.__name__
        return super().output_constant(constant, prefix=f"const {constantType} ", suffix=";")
